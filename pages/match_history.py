...
def run():
    ...
    for g_num in unique_games:
        ...
        # 1. Build the Header
        header_html = f"""<div class="game-header"><strong>Game #{g_num}</strong> — {meta['game_date']} | <span style="color: #aaa;">First Blood: Turn {meta['first_blood_turn']} | End: Turn {meta['end_turn']} | Win Condition: {meta['win_condition']}</span></div>"""
